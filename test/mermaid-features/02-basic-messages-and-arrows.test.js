...
//////////////////////////////////////////////////////////////////////////////
/**
 * Read a UTF-8 fixture file from the basic-messages-and-arrows feature slice.
 *
...
function readFixture(fileName) {
	return fs.readFileSync(path.join(__dirname, "02-basic-messages-and-arrows", fileName), "utf8");
}
...
describe("Mermaid feature slice 2: basic messages and arrow variants", () => {
	test("transforms Mermaid message arrows into sequencer call-line configuration", () => {
		const source = readFixture("input.mmd");
