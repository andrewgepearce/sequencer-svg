...
//////////////////////////////////////////////////////////////////////////////
/**
 * Read a UTF-8 fixture file from the activations feature slice.
 *
...
function readFixture(fileName) {
	return fs.readFileSync(path.join(__dirname, "05-activations", fileName), "utf8");
}

//////////////////////////////////////////////////////////////////////////////
/**
 * Return the absolute path to an activations fixture file.
 *
 * @param {string} fileName Fixture file name.
...
function getFixturePath(fileName) {
	return path.join(__dirname, "05-activations", fileName);
}
...
describe("Mermaid feature slice 5: activations", () => {
	test("transforms Mermaid activation syntax into sequencer flow control", () => {
		const source = readFixture("input.mmd");
	...
	test("renders SVG from Mermaid activation input and writes the transformed sequencer YAML sidecar", () => {
		const tempDir = createTempDir();
